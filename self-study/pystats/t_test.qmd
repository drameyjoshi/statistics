...
$$
where $m = k - 1$ if the population was normally distributed. Otherwise, $m$ is
...
We will see an example of its subtlety in the cases considered below.)
...
$$
\frac{s_1^2}{s_2^2} \sim \frac{\chi^2_{k_1 - 1}}{\chi^2_{k_2 - 1}}.
$$
...
what is called as _parametric statistics_. In the recent years, there has
been a shift towards _nonparametric statistics_. The machine learning
algorithms fall in the latter category.
...
### Combined variance
There is a related statistic called _combined variance_. It is the variance
of multiple samples around the mean of all sample means. In our case, we have
\begin{eqnarray}
\bar{X}_n &=& \frac{X_1 + \cdots + X_n}{n} \\
\bar{X}_m &=& \frac{X_{n+1} + \cdots + X_{n+m}}{m} \\
