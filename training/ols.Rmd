...
$RSS$. It is also called the *deviance*. Let us get them for our model.
```{r}
...
The ratio of variances gives us the $F$-statistic for the model. The number of
...
$F$-statistic is quite sensitive to lack of normality of the residual data. It is
important to check the $QQ$-plot of the residuals while interpreting the $F$-statistic.
